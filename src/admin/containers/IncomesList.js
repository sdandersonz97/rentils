            ...
            <section className='content'>
                <div className='container-fluid'>
                    <Card>
                        ...
                        <CardBody>
                            <Table>
                                <TableHeader titles={['MOUNT','TENANT','MONTHS','OBSERVATION','EMPLOYEE']}/>
                                <TableBody>
                                    {incomesId.length > 0 
...
export default withRouter(connect(mapStatetoProps, { fetchCompanyIncomes, fetchCompanyEmployees })(IncomeList))