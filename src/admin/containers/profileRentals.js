...
class ProfileRentals extends Component {
  ...
  filterEmployeeAssigments = () => {
    ...
    return Object.keys(employeesRentals).filter(
      assigment => employeesRentals[assigment].valid
    );
  };
  ...
  renderTableHeader = () => (
    <TableHeader titles={["COD", "ADDRESS", "DISPONIBILITY"]} />
  );
  render() {
...
export default withRouter(
  connect(mapStateToProps, { fetchCompanyEmployee, fetchCompanyRentals })(
    ProfileRentals
  )
);
